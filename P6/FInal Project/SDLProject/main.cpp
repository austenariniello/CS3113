...
void Initialize() {
    ...
    displayWindow = SDL_CreateWindow("Plane Old Shmup", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 480, SDL_WINDOW_OPENGL);
...
void Update() {
    ...
    else if ((currentScene->state.player->position.y > -50)){
        viewMatrix = glm::translate(viewMatrix, glm::vec3(-4.5f, -currentScene->state.player->position.y - 2.75, 0));
    } else {
        viewMatrix = glm::translate(viewMatrix, glm::vec3(-4.5f, 3.75f, 0));
    }
